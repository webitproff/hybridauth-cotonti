...
## Настройке провайдеров для плагина HybridAuth в Cotonti.

В нём строго перечислены только те провайдеры, которые указаны в официальной таблице поддерживаемых провайдеров Hybridauth 3. 
